...
# State provides the agent with a shared, evolving memory a
# cross nodes so that the agents have the context and instructions needed to act coherently and achieve the goal.
